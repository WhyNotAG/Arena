                  ...
                  child: FlatButton(child: Text("Оплатить",
                    ...
                    onPressed: () async {
                      ...
                      if (_name != null && _infoCheck != null) {
                        if(token != null) {
                         if(isEmail) {
                           response = await postWithToken("http://217.12.209.180:8080/api/v1/booking/booking/", {"bookingsId": ids.toList(), "name": _name,
                          ...
                          if(isEmail) {
                            response = await http.post("http://217.12.209.180:8080/api/v1/booking/booking/",
